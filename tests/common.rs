...
fn verify_with_snp_verify(
    ...
    .map_err(|e| format!("snp::verify::verify_attestation failed: {}", e))
}

pub fn verify_milan_attestation_with_snp_verify() -> Result<(), String> {
    verify_with_snp_verify(MILAN_ATTESTATION, MILAN_ASK, MILAN_VCEK)
}

pub fn verify_genoa_attestation_with_snp_verify() -> Result<(), String> {
    verify_with_snp_verify(GENOA_ATTESTATION, GENOA_ASK, GENOA_VCEK)
}

pub fn verify_turin_attestation_with_snp_verify() -> Result<(), String> {
    verify_with_snp_verify(TURIN_ATTESTATION, TURIN_ASK, TURIN_VCEK)
}

pub fn verify_milan_attestation_with_wrong_genoa_certs() -> Result<(), String> {
    verify_with_snp_verify(MILAN_ATTESTATION, GENOA_ASK, GENOA_VCEK)
}
