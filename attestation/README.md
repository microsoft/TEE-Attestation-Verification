...
```toml
[dependencies]
tee-attestation-verification-lib = { git = "https://github.com/microsoft/TEE-Attestation-Verification", tag = "tav-1.0.0", features = ["crypto_openssl"] }
```
...
```toml
[dependencies]
tee-attestation-verification-lib = { version = "1.0.0", features = ["crypto_openssl", "kds"] }
```
